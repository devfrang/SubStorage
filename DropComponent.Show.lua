...
_G["\u{5F}\u{06C}\u{069}\u{049}\u{06C}\u{006C}\u{069}\u{0069}\u{49}\u{49}\u{006C}\u{6C}\u{69}\u{06B}\u{0049}\u{6B}\u{69}\u{69}\u{6C}\u{49}\u{69}\u{49}\u{06C}\u{6C}\u{069}\u{6B}\u{0049}\u{6B}\u{069}\u{69}\u{0049}\u{6B}\u{06B}"]["\u{69}\u{06B}\u{6B}\u{69}\u{6C}\u{6C}\u{049}\u{49}\u{006C}\u{6B}\u{69}\u{6B}\u{6C}\u{6C}\u{049}\u{006C}\u{006C}\u{6C}\u{69}\u{006B}\u{0069}\u{69}\u{49}\u{6C}\u{6B}\u{6B}\u{49}\u{0069}\u{069}\u{006B}\u{049}\u{49}"][(505771705)-(-38311657)+(6521034)](self,appearType,d,returnPool,key)
end